...
export class CreateBookingDto {
  ...
  @ApiProperty({ example: '+94112233445', description: 'Customer contact number' })
  ...
  @ApiProperty({ example: '18:30', description: 'Start time (HH:mm 24-hour format)' })
  ...
  @ApiProperty({ example: '20:30', description: 'End time (HH:mm 24-hour format)' })
